...
| runAdbShell | Execute a shell command through the current Android Agent. Pass only the shell command, without the adb shell prefix. |
| terminate | Terminate an application through the current Android Agent. |
